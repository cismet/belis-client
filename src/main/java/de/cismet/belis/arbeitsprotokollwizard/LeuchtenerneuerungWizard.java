...
public class LeuchtenerneuerungWizard extends AbstractArbeitsprotokollWizard<TdtaLeuchtenCustomBean> {
     ...
     */
    public LeuchtenerneuerungWizard() {
        initComponents();
    }
    ...
    public Action getAction() {
        return new AbstractAction("Leuchtenerneuerung") {
