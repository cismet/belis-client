...
public class StandortStandsicherheitsPruefungWizard extends AbstractArbeitsprotokollWizard<TdtaStandortMastCustomBean> {
    ...
    public Action getAction() {
        return new AbstractAction("Standsicherheitsprüfung") {
