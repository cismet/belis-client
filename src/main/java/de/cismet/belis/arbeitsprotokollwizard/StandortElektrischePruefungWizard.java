...
public class StandortElektrischePruefungWizard extends AbstractArbeitsprotokollWizard<TdtaStandortMastCustomBean> {
    ...
    public Action getAction() {
        return new AbstractAction("Elektrische Prüfung") {
