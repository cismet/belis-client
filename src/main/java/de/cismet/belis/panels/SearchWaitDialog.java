...
public class SearchWaitDialog extends javax.swing.JDialog {
    ...
    public SearchWaitDialog(java.awt.Frame parent, boolean modal) {
        
        super(parent, modal);
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                initComponents();
                SearchWaitDialog.this.getContentPane().setBackground(Color.GRAY);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/belis/resource/icon/64/searching.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchWaitDialog(new javax.swing.JFrame(), true).setVisible(true);
            }
        });
    }
