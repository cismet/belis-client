 ...
 */
public class ReleaseWaitDialog extends javax.swing.JDialog {
     ...
     */
    public ReleaseWaitDialog(final java.awt.Frame parent, final boolean modal) {
        super(parent, modal);
        EventQueue.invokeLater(new Runnable() {
                ...
                public void run() {
                    initComponents();
                    ReleaseWaitDialog.this.getContentPane().setBackground(Color.GRAY);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Objekte werden für die Bearbeitung freigegeben... ");
    ...
    public static void main(final String[] args) {
        java.awt.EventQueue.invokeLater(new Runnable() {
                ...
                @Override
                public void run() {
                    new ReleaseWaitDialog(new javax.swing.JFrame(), true).setVisible(true);
                }
            });
    }
}
